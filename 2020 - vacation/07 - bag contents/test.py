...
def test_solution1_example():
    ...
    assert solution1.solve(file_input) == 4


def test_solution1():
    file_input = fileinput.FileInput("input.txt")
    assert solution1.solve(file_input) == 289


def test_solution2_example():
    file_input = fileinput.FileInput("test_data.txt")
    assert solution2.solve(file_input) == 32


def test_solution2_example_2():
    file_input = fileinput.FileInput("test_data_2.txt")
    assert solution2.solve(file_input) == 126


def test_solution2():
    file_input = fileinput.FileInput("input.txt")
    assert solution2.solve(file_input) == 30055
