...
def test_solution1_example():
    ...
    assert solution1.solve(file_input) == 165


def test_solution1():
    file_input = fileinput.FileInput("input.txt")
    assert solution1.solve(file_input) == 10452688630537


def test_solution2_example():
    file_input = fileinput.FileInput("test_data_2.txt")
    assert solution2.solve(file_input) == 208


def test_solution2():
    file_input = fileinput.FileInput("input.txt")
    assert solution2.solve(file_input) == 2881082759597
